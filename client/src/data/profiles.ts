...
export const PROFILES: Profile[] = [
  ...
  },
  {
    id: "pregnancy",
    name: "Pregnancy",
    tagline: "Safe, spacious prenatal practice",
    description:
      "Gentle prenatal shapes with belly room, side-lying rest, and supported strength — always follow your clinician's guidance.",
    icon: "Heart",
    accent: "secondary",
    minutesPerSession: 20,
    daysPerWeek: 5,
  ...
  },
  {
    ...
    description:
      "Poses done seated in a chair or standing at a wall — nothing on the floor — with shorter standing holds.",
    icon: "Compass",
    accent: "primary",
    minutesPerSession: 15,
    daysPerWeek: 5,
    // Floor-free only (data/floorAccess.ts) — this profile promises chair and wall.
    recommendedAsanas: [
      "womb-seat",
      "chair-forward-fold",
      "tadasana",
