...
Sadhana’s pose explanation UI plays a looping demo clip when available, and
falls back to the illustrated guide (PNG + focus halo + narration) when not.
...
## UX behavior without videos

Until files exist, the explanation experience still ships:

- Illustrated stage with breathing animation + focus halo
- Narration-synced steps
- Form / Breath / Align / Watch outs / Feel it teaching rail
...
- `client/src/components/PoseDemoStage.tsx` — video + illustration stage
